...
- Added [docs/cli-runtime.md](../../../cli-runtime.md) describing the CLI start-up
  flow, runtime summary, and sanitisation warnings now emitted by the CLI.
- Authored [docs/dependencies.md](../../../dependencies.md) to catalogue runtime
...
- Reviewed server and client dependency manifests, recording supported versions
  and licenses in [docs/dependencies.md](../../../dependencies.md).
...
Archived historical note — superseded by the Apache-2.0 public-release posture.
